...
public class ApartmentsAppApplication extends ListenerAdapter {
  ...
  public static List<String> phonesOfAgents = Arrays.asList("+375447203136");
  ...
  public static KufarReportSeleniumPage kufarReportSeleniumPage;
  public static CatalogReportSeleniumPage catalogReportSeleniumPage;
    ...
    if (lastFlatKufar.getAdTime().after(prevFlatKufar.getAdTime())) {
      ...
      String kufarDesc =
          kufarReportSeleniumPage
              ...
              .replace("(", "")
              .replace(")", "");
      String kufarPhoneNum = kufarReportSeleniumPage.getKufarPhoneNumber();
      if (phonesOfAgents.stream().noneMatch(kufarDesc::contains)
          || phonesOfAgents.stream().noneMatch(kufarPhoneNum::contains)) {
    ...
    if (lastFlatCatalog.getCreatedAt().after(prevFlatCatalog.getCreatedAt())
      ...
      String catalogDesc =
          catalogReportSeleniumPage
              ...
              .replace("(", "")
              .replace(")", "");
      String catalogPhoneNum = catalogReportSeleniumPage.getCatalogPhone();
      if (phonesOfAgents.stream().noneMatch(catalogDesc::contains)
          || phonesOfAgents.stream().noneMatch(catalogPhoneNum::contains)) {
        SendMessage answer = new SendMessage();
        answer.setText(
            String.format(
